...
part 'currencies_api_service.g.dart';
...
abstract class CurrenciesApiService {
  ...
  Future<CurrencyResponseModel> createCurrency(
    @Body() CreateCurrencyRequestModel body,
  );

  @PUT(ApiConstants.currencyById)
  Future<CurrencyResponseModel> updateCurrency(
    @Path('id') int id,
    @Body() UpdateCurrencyRequestModel body,
  );
}
